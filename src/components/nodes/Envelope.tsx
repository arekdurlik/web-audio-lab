...
import { EnvelopeParams, EnvelopeProps } from './types';
...
export function Envelope({ id, data }: EnvelopeProps) {
    ...
    const [params, setParams] = useState<EnvelopeParams>({
        ...{
            ...
            rMin: 0,
            rMax: 2,
            expanded: { a: true, d: true, s: true, r: true },
        },
        ...data.params,
    });
    ...
    const Parameters = (
        <FlexContainer direction="column">
            <RangeInput
                ...
                onExpandChange={v =>
                    setParams(state => ({ ...state, expanded: { ...state.expanded, a: v } }))
                }
            />
            <Hr />
            <RangeInput
            ...
            <RangeInput
                ...
                step={0.001}
                onChange={v => {
                    setParams(state => ({ ...state, r: v }));
                    releaseRef.current = v;
                }}
                numberInput
                numberInputWidth={50}
                adjustableBounds
