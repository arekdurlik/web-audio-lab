...
export function Oscillator({ id, data }: OscillatorProps) {
    ...
    useEffect(() => {
        if (params.playing) {
            ...
            instance.current = new OscillatorNode(audio.context, {
                ...
                ...(params.type === 'custom' && {
                    periodicWave: audio.context.createPeriodicWave(params.real, params.imag),
                }),
            });
    ...
    useEffect(() => {
        ...
        instance.current.setPeriodicWave(
            audio.context.createPeriodicWave(params.real, params.imag)
        );
    ...
    const Parameters = (
        <FlexContainer direction="column">
            ...
            <RangeInput
                ...
                onExpandChange={v =>
                    setParams(state => ({ ...state, expanded: { ...state.expanded, f: v } }))
                }
            />
            <Hr />
            <RangeInput
                ...
                onExpandChange={v =>
                    setParams(state => ({ ...state, expanded: { ...state.expanded, d: v } }))
                }
            />
            {params.type === 'custom' ? (
                <CustomWrapper>
